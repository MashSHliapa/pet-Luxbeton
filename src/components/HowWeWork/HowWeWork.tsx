...
export const HowWeWork = () => {
  return (
    <div className="how-we-work" id="howWeWork">
      <div className="how-we-work__container _container">
        <div className="how-we-work__body">
          <div className="how-we-work__title">
            <Title>КАК МЫ РАБОТАЕМ</Title>
          </div>
          <div className="how-we-work__subtitle">
          ...
          <ul className="how-we-work__list">
            <li className="how-we-work__item1">
              <div className="how-we-work__number">1</div>
              <p className="how-we-work__text text-black">
                Вы <b>оставляете</b> заявку на нашем сайте или звоните менеджеру
              </p>
            </li>
            <li className="how-we-work__item2">
              <div className="how-we-work__number">2</div>
              <p className="how-we-work__text text-black">
                Делаем <b>расчет цены</b> и совместимости под ваши условия
              </p>
            </li>
            <li className="how-we-work__item3">
              <div className="how-we-work__number">3</div>
              <p className="how-we-work__text text-black">
                Заключаем <b>договор</b> (предоплата от 50%)
              </p>
            </li>
            <li className="how-we-work__item4">
              <div className="how-we-work__number">4</div>
              <p className="how-we-work__text text-black">
                <b>Изготавливаем</b> в течение 10-15 рабочих дней
              </p>
            </li>
            <li className="how-we-work__item5">
              <div className="how-we-work__number">5</div>
              <p className="how-we-work__text text-black">
                Оповещаем Вас о готовности и согласовываем с Вами <b>отправку изделий</b>
              </p>
            </li>
            <li className="how-we-work__item6">
              <div className="how-we-work__number">6</div>
              <p className="how-we-work__text text-black">
      ...
      <div className="how-we-work__background background _ibg">
